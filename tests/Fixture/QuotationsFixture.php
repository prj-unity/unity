...
class QuotationsFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '見積りID', 'autoIncrement' => true, 'precision' => null],
        ...
        'contents' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '見積り内容', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'deleted' => 1,
            'created' => '2017-04-22 22:34:39',
            'modified' => '2017-04-22 22:34:39'
        ],
    ];
}
