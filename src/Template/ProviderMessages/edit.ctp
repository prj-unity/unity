...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $providerMessage->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $providerMessage->id)]
            )
        ?></li>
...
<div class="providerMessages form large-9 medium-8 columns content">
    <?= $this->Form->create($providerMessage) ?>
    <fieldset>
        <legend><?= __('Edit Provider Message') ?></legend>
        <?php
